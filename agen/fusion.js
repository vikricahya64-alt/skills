...
const DOMAINS = [
  ...
  { d: "app", kw: ["frontend", "backend", "web", "react", "javascript", "typescript", "api", "fullstack", "mobile", "android", "ios", "ux", "ui", "design", "app"] },
  ...
  { d: "performance", kw: ["performance", "performa", "percepat", "latency", "low latency", "throughput", "concurrency", "parallel", "async", "cache", "caching", "scal", "load", "benchmark", "profiling", "optimize", "optimization", "web vitals", "turbopack", "turborepo", "autoscaler", "compute class", "cost optimiz"] },

...
---
*Diimpor dari ekosistem plugin `cloud/data-agent-kit/bigquery-data-analytics` (submodule repo `gemini-cli-extensions/bigquery-data-analytics`) untuk gcp-agent.*
